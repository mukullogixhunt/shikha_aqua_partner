...
import com.logixhunt.shikhaaquapartner.databinding.FragmentCollectionBinding;
...
import com.logixhunt.shikhaaquapartner.ui.fragments.collectiontabs.BottleCollectionFragment;
import com.logixhunt.shikhaaquapartner.ui.fragments.collectiontabs.PaymentCollectionFragment;
...
public class CollectionFragment extends BaseFragment {
    ...
    private void initialization() {
        myFragmentPagerAdapter = new CustomFragmentPagerAdapter(getChildFragmentManager(), getLifecycle());
        myFragmentPagerAdapter.addFragment(new PaymentCollectionFragment());
        myFragmentPagerAdapter.addFragment(new BottleCollectionFragment());
        binding.viewPager.setAdapter(myFragmentPagerAdapter);
        new TabLayoutMediator(binding.tabLayout, binding.viewPager,
                (tab, position) -> {
                    switch (position) {
                        case 0:
                            tab.setText("Collect Payment");
                            break;
                        case 1:
                            tab.setText("Collect Bottles");
                            break;
                    }
                }).attach();
    }
