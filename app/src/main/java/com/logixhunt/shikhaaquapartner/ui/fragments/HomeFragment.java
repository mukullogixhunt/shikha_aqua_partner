...
import com.logixhunt.shikhaaquapartner.databinding.FragmentHomeBinding;
...
public class HomeFragment extends BaseFragment {
    ...
    private void initialization() {
        ...
        myFragmentPagerAdapter.addFragment(new PendingBookingFragment());
        myFragmentPagerAdapter.addFragment(new AcceptedBookingFragment());
