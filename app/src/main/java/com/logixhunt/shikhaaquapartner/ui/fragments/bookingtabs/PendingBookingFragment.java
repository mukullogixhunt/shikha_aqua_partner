...
import com.logixhunt.shikhaaquapartner.databinding.FragmentPendingBookingBinding;
 ...
 */
public class PendingBookingFragment extends BaseFragment implements RequestOnStatusChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPendingBookingBinding.inflate(getLayoutInflater(), container, false);
        getPreferenceData();
        initialization();
    ...
    private void getOrdersApi() {
        ...
        Call<OrderResponse> call = apiInterface.getOrderList(userModel.getmExecutiveId(),"3");
    ...
    public void onStatusChange(OrderModel orderModel) {
        updateStatusApi(orderModel.getmOrderId());
    }


    private void updateStatusApi(String bookingId) {
        showLoader();
        ApiInterface apiService = ApiClient.getClient().create(ApiInterface.class);
        Call<BaseResponse> call = apiService.updateOrderStatus(bookingId, "4", userModel.getmExecutiveId());
